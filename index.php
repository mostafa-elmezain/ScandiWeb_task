    ...
    <body>
        <form method='post' action='/'>
                ...
                <div class='container-fluid pt-3'>
                    ...
                    <div class='justify-content-end' id='navbarSupportedContent'>
                        <div class='d-flex pe-5'>
                            ...
                            <button class='btn btn-outline-danger' type='submit' name='Mass_Delete'> MASS DELETE </button>
                        </div>
                    </div>
                </div>
            </nav>
            <div class="container-fluid">  
                ...
                <?php echo Delete_Product::Delete(); ?>
                ...
                <div class="p-5">
                    <div class="row row-cols-4 g-4 ">
                        ...
                        <div class="card me-4" style="width: 18rem;">
                            <div class="card-body">
                                <input type="checkbox" class="delete-checkbox" name='Delete_Checkbox[]' value='<?= $product['id'] ?>'>
